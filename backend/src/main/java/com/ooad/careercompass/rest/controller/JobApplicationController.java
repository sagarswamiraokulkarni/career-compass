...
public class JobApplicationController {
    ...
    public GenericResponse updateJobApplicationStarredStatus(@PathVariable("userId") Integer userId, @PathVariable("jobApplicationId") Integer jobApplicationId) throws Exception {
